...
echo "Done:"
echo "  $OUT_DIR/wordlist_en_ipa.txt"
echo "  $OUT_DIR/wordlist_en_noipa.txt"
echo "  $OUT_DIR/wordlist_de_ipa.txt"
echo "  $OUT_DIR/wordlist_de_noipa.txt"
echo "  $OUT_DIR/wordlist_tr_ipa.txt"
echo "  $OUT_DIR/wordlist_tr_noipa.txt"
